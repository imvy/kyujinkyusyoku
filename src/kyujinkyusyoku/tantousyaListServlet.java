...
/**
 * Servlet implementation class tantousyaListServlet
 */
@WebServlet("/tantousyaListServlet")
public class tantousyaListServlet extends HttpServlet {
	...
	private void perform(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(actString.equals("show")) {
    		...
    		list=tantousyaListServices.selectAllKyujinDept(kyujinkaisyaId);
    		JsonElement element = gson.toJsonTree(list, new TypeToken<List<tantouListFetchModel>>(){
    		}.getType());
