 ...
 */
@WebServlet("/KyusyokuConfilmServletAdd")
public class KyusyokuConfilmServletAdd extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public KyusyokuConfilmServletAdd() {
        super();
...
*/
				...
				int kyujinId = Integer.parseInt(kyujinId3);//"0"を、0に型変換
...
//				kbean2.setKyusyokusyaId(request.getParameter("kyusyokusyaId2"));

				String kyusyokusyaId = request.getParameter("kyusyokusyaId2");
				int kyusyokusyaId2 = Integer.parseInt(kyusyokusyaId);
				kbean2.setKyusyokusyaId(kyusyokusyaId2);
...
//変更No.035_kim ソース追記 - Start
				...
				if(kyujinId4.equals("")||kyujinId4.equals("0")) {kyujinId4 = "1";}  //"","0"の場合に、"1"を代入
				int kyujinId2 = Integer.parseInt(kyujinId4);//"1"を、1に型変換
...
//変更No.035_kim - End
				...
				session.setAttribute("kyusyokuList2Add", kbean2);

				rd = request.getRequestDispatcher("/kyusyokuConfilm2Add.jsp");
