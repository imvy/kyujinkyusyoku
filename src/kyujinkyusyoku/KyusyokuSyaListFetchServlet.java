 ...
 */
@WebServlet("/KyusyokuSyaListFetchServlet")
public class KyusyokuSyaListFetchServlet extends HttpServlet {
     ...
     */
    public KyusyokuSyaListFetchServlet() {
        super();
	...
	private void perform(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(actString.equals("show")) {
    		list=KyusyokuSyaListFetchServices.selectAll();
