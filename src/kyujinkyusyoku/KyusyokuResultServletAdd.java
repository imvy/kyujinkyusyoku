 ...
 */
@WebServlet("/KyusyokuResultServletAdd")
public class KyusyokuResultServletAdd extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public KyusyokuResultServletAdd() {
        super();
...
//変更No.018 if文の追加 - End
		...
		try {
			kdao.updateKyusyoku(kyusyokusyaId, kyusyokuName,kyusyokuNameFurigana ,jyusyo, seinengappi, renrakusakiKyusyokusya, kyusyokuId, kibousyokusyu, uketukenengappi,
				...
				rd = request.getRequestDispatcher("/kyusyokuUResult.jsp");
			...
			case "追加" :
				 ...
				 kbean = (KyusyokuBean) session.getAttribute("kyusyokuList2Add");
