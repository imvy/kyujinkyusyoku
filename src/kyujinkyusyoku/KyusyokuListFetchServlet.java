 ...
 */
@WebServlet("/KyusyokuListFetchServlet")
public class KyusyokuListFetchServlet extends HttpServlet {
     ...
     */
    public KyusyokuListFetchServlet() {
        super();
	...
	private void perform(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if(actString.equals("show")) {
    		list=KyusyokuListFetchServices.selectAll();
