    ...
    <div class="wrapper  fadeInDown">
      <div id="formContent">
        ...
        <form action="LoginServlet" method="post" name="login_form">
          <input type="text" id="login" class="fadeIn second" name="userId" placeholder="user">
          <input type="password" id="password" class="fadeIn third" name="pass" placeholder="pass">
