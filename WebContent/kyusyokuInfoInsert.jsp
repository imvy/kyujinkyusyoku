...
<html>
  ...
  <body class="mainBody">
    <div class="wrapper1">
	    <h1>求職情報の追加</h1>
	    <div class="wrapper2">
	      <form action="KyusyokuConfilmServlet" method="post" class="needs-validation" novalidate>
        <!-- 変更No.040_kim jsp:getPropertyの追加・inputタグのname属性の値を変更 - Start -->
          <div class="form-group row">
            <label class="col-sm-2 control-label">求職者氏名</label>
            <div class="col-sm-10">
              <jsp:getProperty property="kyusyokuName" name="kyusyokuSyaList"/>
            </div>
          </div>
	        <div class="form-group row">
	          <label class="col-sm-2 control-label">ふりがな</label>
	          <div class="col-sm-10">
	            <jsp:getProperty property="kyusyokuNameFurigana" name="kyusyokuSyaList"/>
	          </div>
	        </div>
	        <div class="form-group row">
	          <label class="col-sm-2 control-label">住所</label>
	          <div class="col-sm-10">
	            <jsp:getProperty property="jyusyo" name="kyusyokuSyaList"/>
	          </div>
	        </div>
	        <div class="form-group row">
	          <label class="col-sm-2 control-label">生年月日</label>
	          <div class="col-sm-10">
	            <jsp:getProperty property="seinengappi" name="kyusyokuSyaList"/>
	          </div>
	        </div>
	        <div class="form-group row">
	          <label class="col-sm-2 control-label">連絡先</label>
	          <div class="col-sm-10">
	            <jsp:getProperty property="renrakusakiKyusyokusya" name="kyusyokuSyaList"/>
	          </div>
	        </div>
				  <div class="form-group row">
	          <label class="col-sm-2 control-label"><span class="badge badge-danger">必須</span><br>求職希望職種 </label>
	          <div class="col-sm-3">
	        ...
	        <div class="form-group row">
	          <label class="col-sm-2 control-label"><span class="badge badge-danger">必須</span><br>受付年月日 </label>
	        ...
	        <br>
				  <input type="submit" class="btn btn-info" name="submit5" value="追加する求職情報の確認">
              ...
              <div class="form-group row">
	              <label class="col-sm-2 control-label"><span class="badge badge-danger">必須</span><br>求人受理整理番号 <br><a href ="javascript:void(0);" class="btn btn-link" onclick="window.open('kyujinListFetch.jsp','newwindow','top=' + y + ',left=' + x + ',width=1300,height=930')">求人一覧</a></label>
	              <div class="col-sm-4">
...
<%--
	...
	<input type="submit" class="btn btn-danger" name="submit2" value="求職一覧へもどる">
	</form>
--%>
      </div>
    </div>
